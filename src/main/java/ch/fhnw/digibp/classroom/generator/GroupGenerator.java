...
public class GroupGenerator {
    ...
    public void init() {
        ...
        groupService.createGrantGroupAuthorization(new String[]{"manager"}, new Permission[]{Permissions.ALL}, Resources.APPLICATION, new String[]{"tasklist", "cockpit"});
        groupService.createGrantGroupAuthorization(new String[]{"analyst"}, new Permission[]{Permissions.ALL}, Resources.APPLICATION, new String[]{"optimize"});
        groupService.createGrantGroupAuthorization(new String[]{"engineer"}, new Permission[]{Permissions.ALL}, Resources.APPLICATION, new String[]{"*"});
